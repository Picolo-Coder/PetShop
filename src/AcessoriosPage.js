  ...
  useEffect(() => {
    ...
    useEffect(() => {
        fetch('http://127.0.0.1:8000/produtos/')
            ...
            .then(data => {
                // Filtra os produtos para incluir apenas aqueles do tipo Acessórios (id 3)
                                ...
                                acessorios.map((acessorio) => (
                                    <div key={acessorio.id} className="col-md-4 mb-4">
                                        <div className="card" id='card02' style={{ width: '18rem' }}>
                                            <img 
                                                src={`http://127.0.0.1:8000/produtos/${acessorio.id}/imagem`} // URL da imagem do acessório
                                                className="card-img-top"
                                                alt={acessorio.nome} // Nome do produto como alt
                                                onError={(e) => {
